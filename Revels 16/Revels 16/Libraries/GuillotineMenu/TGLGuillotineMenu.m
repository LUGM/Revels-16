...
//	cell.alpha = 1.0;
//	CGFloat randomTime = MIN(1.5, arc4random_uniform(100)/100 + 0.5);
//	CGFloat randomDelay = MIN(0.5, arc4random_uniform(100)/200);
//	[UIView animateWithDuration:randomTime delay:randomDelay options:UIViewAnimationOptionCurveEaseOut animations:^{
